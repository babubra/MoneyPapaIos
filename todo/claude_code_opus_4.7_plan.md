...
**1. Дата transactions/debts сдвигается на -1 день при КАЖДОМ sync round-trip (накопительный timezone-bug) — 🔴 CRITICAL** (2026-05-13, сессия `flickering-prancing-prism`, ручной тест в симуляторе)
